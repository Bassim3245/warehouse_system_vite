...
const LogById = () => {
  ...
  useEffect(() => {
    dispatch(setLanguage());
      ...
      const fetchDataByProjectId = useCallback(async () => {
        ...
        try {
          const response = await fetchData({
            ...
            onSuccess: (data) => {
              console.log('Data fetched successfully in LogById:', data);
      ...
      }, [fetchData, page, limit, roles?.show_log_entity?._id, applicationPermission?.materialObsolete?._id, dataUserById?.entity_id]);
    
      useEffect(() => {
        fetchDataByProjectId();
        console.log('Data fetched successfully:', dataLog);
