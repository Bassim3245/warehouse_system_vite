...
export default function GenerateReport() {
  ...
  let dataExport;
  useEffect(() => {
    setReportEntity(paramsQuery.get("reportEntity"));
    switch (reportEntity) {
      case true:
        console.log("heeeee=>", "true");
        dataExport = exportData2;
        break;
      case false:
        console.log("heeeee=>", "false");
        dataExport = exportData;
        break;
      default:
        console.log("heeeee=>", "default");
        dataExport = [];
        break;
    }
  }, [paramsQuery]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requestData = {
        ...
        format: reportFormat,
        ifEntity: paramsQuery.get("reportEntity"),
        user_id: dataUserById?.user_id,
        entity_id: paramsQuery.get("entity_id"),
      };
