...
export const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        ...
        (
          ...
          setCompanyStructure(companyPermission);
    ...
    builder
      .addCase(fetchDataUserEntityId.pending, (state) => {
        state.loading = true;
        state.isError = false;
      })
      .addCase(fetchDataUserEntityId.fulfilled, (state, { payload }) => {
        state.loading = false;
        state.isSuccess = true;
        state.dataUsers = payload;
      })
      .addCase(fetchDataUserEntityId.rejected, (state, { payload }) => {
        state.loading = false;
        state.isError = true;
        state.dataUsers=[]
      });
